...
const planSpecs = {
  ...
  // ... sisa plan specs Anda
  "unlimited": { ram: "0", disk: "0", cpu: "0" }
};

// --- PERBAIKAN 1: Ubah app.get menjadi app.post ---
app.post('/panel/create-server', async (req, res) => {
  
  // --- PERBAIKAN 2: Ambil data dari req.body, bukan req.query ---
  const { plan, domain, plta, egg, nestid, loc, username } = req.body;
